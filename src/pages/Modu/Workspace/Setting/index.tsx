      ...
      label: (
        <>
          <Space align="center" size={0}>
            ...
            {intl.formatMessage({ id: 'modu.space.setting.tab.providers' })}
          </Space>
        </>
      ),
      ...
      label: (
        <>
          <Space align="center" size={0}>
            ...
            {intl.formatMessage({ id: 'modu.space.setting.tab.members' })}
          </Space>
        </>
      ),
  ...
  const moreItems: MenuProps['items'] = [
    {
      label: (
        <Typography.Text>
          {intl.formatMessage({
            id: 'modu.space.setting.tab.more.transferOwner',
          })}
        </Typography.Text>
      ),
      key: 'transferOwner',
    ...
    },
    {
      label: (
        <Typography.Text type="danger">
          {intl.formatMessage({ id: 'modu.space.setting.tab.more.deleteTeam' })}
        </Typography.Text>
      ),
      key: 'deleteTeam',
      disabled: true,
